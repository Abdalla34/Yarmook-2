<template>
  <div class="w-full px-3 pt-4 pb-1 md:px-5">
    <div class="flex items-center gap-2 px-4 py-3 max-w-4xl mx-auto bg-white border border-gray-200 rounded-[20px] shadow-sm overflow-x-auto [&::-webkit-scrollbar]:hidden">
