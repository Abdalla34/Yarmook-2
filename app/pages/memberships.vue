    ...
    <div class="container mx-auto px-4 py-8">
        <div class="w-full lg:w-2/3 mx-auto">
            ...
            <div v-if="loading" class="space-y-4">
                <div v-for="n in 3" :key="n" class="rounded-2xl border border-gray-200 bg-white p-6 animate-pulse">
                        ...
                        <div class="relative z-10 p-6 flex flex-col justify-end min-h-[220px]">
                            <div class="flex items-start justify-between gap-4">
                                <div>
                                    ...
                                    <p class="mt-1 text-sm text-gray-300">{{ selectedCar?.brand?.title }} - {{
            ...
            <!-- Empty state -->
            <div v-if="!loading && !memberships.length" class="flex flex-col items-center justify-center py-16">
