...
export const PayMents = () => {
    ...
    const checkOnDelivery = async (order_id: any) => {
        return await $fetch(`${config.public.apiBase}/payment/cash-on-delivery/${order_id}`, {
            method: "GET",
            headers,
        });
    };
    return { usePayment, usePaymentMembership, usePaymentToChargeWallet, getHyperpayStatus, tamaraPayment, tabyPayment, tabbyStatusSuccess, tabbyStatusFailure, tabbyStatusCancel, checkOnDelivery }
}